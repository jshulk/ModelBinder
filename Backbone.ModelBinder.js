...
(function (factory) {
    ...
    _.extend(Backbone.ModelBinder.prototype, {
        ...
        _initializeDefaultBindings: function(){
            ...
            //getting the elements with the attribute name
            ...
            for(elCount = 0; elCount < elsWithAttribute.length; elCount++){
                ...
                // value of the name attribute of the element and it also
                // corresponds to the attribute in the model.
                ...
                // if we do not have the bindings supplied.
                // structure of attributeBindings -
                // {"firstName": { elementBindings:
                //                  [{ attributeBinding: attributeBinding, boundEls: [matchedEls]  }]
                //               } 
                //  }
                if(!this._attributeBindings[name]){
                    ...
                    // everytime we are pushing a new binding we are store a reference
                    // to all the existing bindings for that attribute.
            ...
            for (elementBindingCount = 0; elementBindingCount < attributeBinding.elementBindings.length; elementBindingCount++) {
                ...
                for (boundElCount = 0; boundElCount < elementBinding.boundEls.length; boundElCount++) {
                    ...
                    if(!boundEl._isSetting){
                        //converts the model's attribute value before updating the element.
